...
If you have already completed module #1, you can update the existing stack with the starting point for module #2.  Otherwise if you skipped the first module, you can create a new stack with the starting point for module #2. 

<details>
<summary><strong>CloudFormation Update Stack Instructions (expand for details)</strong></summary><p>
...
<details>
<summary><strong>Alternative: If you skipped Module 1 you can start with Module 2 (expand for details)</strong></summary><p>
...
In this section you will execute a python script that posts http header data to your front end web servers.
...
3.  Locate the DataGenerator key and copy the Value in the browser.  
<details>
<summary><strong>Example Command (expand for details)</strong></summary>

```bash
	python ./test-beacon.py http://realt-Appli-1P8C8FJ52YGXM-558059401.us-east-1.elb.amazonaws.com/beacon 20000 0.5
```
